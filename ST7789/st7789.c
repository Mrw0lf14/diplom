...
void myfunc_DrawFilledRectangle(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color){

}
void mfunc_UpdateFrame(uint16_t x, uint16_t y, uint16_t x2, uint16_t y2){
	uint16_t i;
		ST7789_SetAddressWindow(x, y, x2, y2);
		ST7789_Select();
